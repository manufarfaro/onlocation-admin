...
class PaginationTagLib {
	...
	def paginate = { attrs ->
		...
		writer << '<ul class="pagination" style="display:inline-block">'
		...
		// Left Arrow
			...
			if (currentstep > firststep) {
				...
				writer << '<a aria-label="Previous">'
				writer << '<i class="fa fa-chevron-left"></i>'
				writer << '</a>'
			}
			writer << '</li>'
		...
		// Right Arrow
			...
			if (currentstep < laststep) {
				...
				writer << '<a aria-label="Previous">'
				writer << '<i class="fa fa-chevron-right"></i>'
				writer << '</a>'
			}			
			writer << '</li>'
