...
class ClientController {
	...
	@Transactional
	def resetPassword(Client clientInstance) {
		if (clientInstance == null) {
			notFound()
			return
		}

		String randomString = org.apache.commons.lang.RandomStringUtils.random(15, true, true)

		clientInstance.password = randomString
		clientInstance.passwordExpired = true
		clientInstance.save flush:true
		
		[
			clientInstance: clientInstance,
			passwordGenerated: randomString 
		]
	}
